...
module.exports = function (app) {
    ...
    app.post('/orders/filter', requireAuth, Order.filterOrder);
    ...
    app.put('/orders/purchased', requireAuth, Order.orderPurchased);
    ...
    app.delete('/orders/package', requireAuth, Order.dismissPackage);
